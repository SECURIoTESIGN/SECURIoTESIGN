...
SecD4CLOUDMOBILEv1.1 was developed by Francisco T. Chimuco and Pedro R. M. Inácio from the Instituto de Telecomunicaçoes, and Department of Computer Science, Universidade da Beira Interior, Covilha, Portugal.
...
3. Compile and run the application. The source code can be found in the SecD4CLOUDMOBILEv1.1.py file, which must be compiled from the application. 
