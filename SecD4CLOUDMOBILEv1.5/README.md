...
3. Compile and run the application using the main.py file, which must be executed from the IDE or terminal;
4. Or you can download the SecD4CLOUDMOBILEv1.5 executable from https://drive.google.com/file/d/1KPReCgsFmKMwTOVf81rby2hWwwCFOxeb/view?usp=sharing.   
